...
if ($_GET && isset($_GET['product']) && is_numeric($_GET['product'])) {
    if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST["add_review"] == "add review") {
        if (isset($_POST['ratingRadio'])) {
            $reviewObj->setProduct_id($_GET['product']);
            $reviewObj->setUser_id($_SESSION['user']->id);
            $reviewObj->setRate($_POST['ratingRadio']);
            $reviewObj->setComment($_POST['comment'] ?? "");
        }
        if ($reviewObj->create()) {
...
if (isset($_SESSION['user'])) {
    $reviewDiv .= "<div class='ratting-form-wrapper'>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="product-details-content">
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            <li class="categories-title"><a href="shop.php?cat=<?= $product->category_id ?>"><?= $product->category_name_en ?></a>
                            </li>
