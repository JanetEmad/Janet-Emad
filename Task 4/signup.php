              ...
              <div class="login-form-container">
                <div class="login-register-form">
                  ...
                  <form action="#" method="post">
                    ...
                    <input name="email" placeholder="Email Address" type="email" value="<?= $validation->getOldValue('email') ?>" />
                    <?= $validation->getMessage('email') ?>
                    <input name="phone" placeholder="Phone" type="number" value="<?= $validation->getOldValue('phone') ?>" />
